...
| `internal/sync`                | State → adapters, plus redundant-link removal (canonical-store links only; tracked-collection/fallback links never removed). Never edits the state file.                                                                                                                                                                                              |
